...
RSpec.describe PostsController, type: :controller do
  ...
  # when create is invoked, the newly created Post object is
  ...
  describe "GET new" do
    ...
    #we use the render_template method to verify the correct view
    #is rendered
    ...
    #3 we expect the @post instance variable to be initialized by
    #PostsController#new
    #assigns gives us access to @post variable, assigning it to :post
